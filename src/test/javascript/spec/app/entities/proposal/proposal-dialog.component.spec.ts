...
import { ProposalDialogComponent } from '../../../../../../main/webapp/app/entities/proposal/proposal-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Proposal Management Dialog Component', () => {
        let comp: ProposalDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ProposalDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'proposalListModification', content: 'OK'});
