            ...
            if (id) {
                this.postService.find(id)
                    .subscribe((postResponse: HttpResponse<Post>) => {
                        ...
                        post.creationDate = this.datePipe
                            .transform(post.creationDate, 'yyyy-MM-ddTHH:mm:ss');
                        post.publicationDate = this.datePipe
                            .transform(post.publicationDate, 'yyyy-MM-ddTHH:mm:ss');
