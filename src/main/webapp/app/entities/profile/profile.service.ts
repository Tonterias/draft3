...
export class ProfileService {
    ...
    private convertItemFromServer(profile: Profile): Profile {
        ...
        copy.creationDate = this.dateUtils
            .convertDateTimeFromServer(profile.creationDate);
        copy.birthdate = this.dateUtils
            .convertDateTimeFromServer(profile.birthdate);
        return copy;
    }
    ...
    private convert(profile: Profile): Profile {
        ...
        copy.creationDate = this.dateUtils.toDate(profile.creationDate);

        copy.birthdate = this.dateUtils.toDate(profile.birthdate);
        return copy;
    }
}
