            ...
            if (id) {
                this.profileService.find(id)
                    .subscribe((profileResponse: HttpResponse<Profile>) => {
                        ...
                        profile.creationDate = this.datePipe
                            .transform(profile.creationDate, 'yyyy-MM-ddTHH:mm:ss');
                        profile.birthdate = this.datePipe
                            .transform(profile.birthdate, 'yyyy-MM-ddTHH:mm:ss');
