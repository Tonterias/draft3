...
export class PhotoService {
    ...
    search(req?: any): Observable<HttpResponse<Photo[]>> {
        const options = createRequestOption(req);
        return this.http.get<Photo[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Photo[]>) => this.convertArrayResponse(res));
    }
    ...
    private convertItemFromServer(photo: Photo): Photo {
        ...
        copy.creationDate = this.dateUtils
            .convertDateTimeFromServer(photo.creationDate);
        return copy;
    }
    ...
    private convert(photo: Photo): Photo {
        ...
        copy.creationDate = this.dateUtils.toDate(photo.creationDate);
        return copy;
    }
}
