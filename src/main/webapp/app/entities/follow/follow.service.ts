...
export class FollowService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/follows';
    ...
    search(req?: any): Observable<HttpResponse<Follow[]>> {
        const options = createRequestOption(req);
        return this.http.get<Follow[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Follow[]>) => this.convertArrayResponse(res));
    }
    ...
    private convertItemFromServer(follow: Follow): Follow {
        ...
        copy.creationDate = this.dateUtils
            .convertDateTimeFromServer(follow.creationDate);
        return copy;
    }
    ...
    private convert(follow: Follow): Follow {
        ...
        copy.creationDate = this.dateUtils.toDate(follow.creationDate);
        return copy;
    }
}
