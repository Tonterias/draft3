...
export class NotificationService {
    ...
    private convertItemFromServer(notification: Notification): Notification {
        ...
        copy.notificationDate = this.dateUtils
            .convertDateTimeFromServer(notification.notificationDate);
        return copy;
    }
    ...
    private convert(notification: Notification): Notification {
        ...
        copy.creationDate = this.dateUtils.toDate(notification.creationDate);

        copy.notificationDate = this.dateUtils.toDate(notification.notificationDate);
        return copy;
    }
}
