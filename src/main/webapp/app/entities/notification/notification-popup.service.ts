            ...
            if (id) {
                this.notificationService.find(id)
                    .subscribe((notificationResponse: HttpResponse<Notification>) => {
                        ...
                        notification.creationDate = this.datePipe
                            .transform(notification.creationDate, 'yyyy-MM-ddTHH:mm:ss');
                        notification.notificationDate = this.datePipe
                            .transform(notification.notificationDate, 'yyyy-MM-ddTHH:mm:ss');
